...
import { GraduationCap, Home, FileText, Presentation, BookOpen, Briefcase, Send, MessageCircle, Facebook, ClipboardList, User, LogOut, Shield, Bell, CreditCard, HeadphonesIcon, Gift, Edit3 } from "lucide-react";
