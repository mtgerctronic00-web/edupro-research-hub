...
const FreeSample = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const {
        error
      } = await supabase.from("free_samples").insert([{
        user_id: user.id,
  ...
  if (isSubmitted) {
    return <AppLayout>
        <PageHeader title="تم إرسال الطلب" description="طلب العينة المجانية" icon={Gift} gradient="from-green-500 to-emerald-600" />
        <div className="container mx-auto px-4 py-8">
          <Card className="max-w-2xl mx-auto p-8 text-center space-y-6 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center pt-4">
              <a href="https://wa.me/9647735777457" target="_blank" rel="noopener noreferrer" className="inline-flex">
                <Button className="w-full sm:w-auto gap-2">
                  <MessageCircle className="h-4 w-4" />
                  تواصل عبر واتساب
                </Button>
              </a>
              <a href="https://t.me/Oo9p" target="_blank" rel="noopener noreferrer" className="inline-flex">
  ...
  return <AppLayout>
      <PageHeader title="خدمة مجانية أولية" description="احصل على عينة مجانية من 1-4 صفحات" icon={Gift} gradient="from-primary to-secondary" />
      <div className="container mx-auto px-4 py-8">
        <Card className="max-w-2xl mx-auto p-8 animate-fade-in">
          <div className="mb-6 p-4 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-xl">
            <h3 className="font-semibold mb-2 text-lg">خدمة مقدمة مجانية</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input id="university" required value={formData.university} onChange={e => setFormData({
              ...formData,
            ...
            <div className="space-y-2">
              ...
              <Input id="topic" required value={formData.topic} onChange={e => setFormData({
              ...formData,
            ...
            <div className="space-y-2">
              ...
              <Input id="pagesCount" type="number" min="1" max="4" required value={formData.pagesCount} onChange={e => setFormData({
              ...formData,
            ...
            })} placeholder="أضف أي تفاصيل إضافية تساعدنا في إعداد العينة" rows={4} />
            </div>
